		...
		if (this.state.live && this.state.paused) {
			...
			if (this.state.ready['TERRORIST'] != this.state.ready['CT']) {
				...
				if(this.state.knife) {
					...
					this.rcon('mp_maxmoney 16000;mp_unpause_match;mp_warmup_pausetimer 0;mp_warmuptime 6;mp_warmup_start;tv_record '+demo+';say \x10Both teams are \x04!ready\x10, starting match in:;say \x085...');
